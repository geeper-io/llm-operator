...
import HelmInstallSnippet from '@site/src/components/HelmInstallSnippet';

<HelmInstallSnippet />

### Option B: Using kubectl

import KubectlInstallSnippet from '@site/src/components/KubectlInstallSnippet';

<KubectlInstallSnippet />
